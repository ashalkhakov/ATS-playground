// this is just a sketch, based on
// https://github.com/githwxi/ATS-Postiats/blob/master/doc/EXAMPLE/ATSLF/naive-set.dats
...
// now that we have sets...
// set of labels
// every label is associated to a position in a tuple
sortdef interp = (elt) -> t@ype
